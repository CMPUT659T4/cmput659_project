...
a SGMRF classifier, provided the best accuracy of $74.16\%$ on our multi-site 
...
size for training. When comparing Rish (Full/DLPFC) in Table~\ref{holdout_table} 
...
we considered many other features in our other features section, few performed
well. The best of these was closely related to the Rish (Full) approach which
indicated that voxel degree was the most useful feature that we were able to
