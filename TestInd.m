function test_ind = TestInd(data,percentage)
    ...
    testSet.Site = [1:5];
    testSet.Number_data = [0010,0006,0003,0018,0009];
    testSet.Subject = [23,6,21,23,22];
    testSet.Schizophernia = [10,5,10,11,10];
    testSet.Healthy = [13,1,11,12,12];
    testSet.test_sch = [2,1,2,2,2];
    testSet.test_hel = [3,0,2,2,2];
    yTemp=data(:,end);
