...
file_name<-"res_exp_scalar_SF.txt"
fnm_table<-"res_table_exp_scalar_SF.txt"
fnm_sum_table<-"res_sum_table_exp_scalar_SF.txt"
...
#N_vector<-c(1000)
b_vector<-c(1/1,1/0.1,1/0.01,1/0.005,1/0.001,1/0.0005,1/0.0001);
