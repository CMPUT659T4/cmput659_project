...
ifvec=1; % vector formulation(1) or scalar formulation(0)
usediag=0; % 0 - regularize diagonal, 1 - "regularized likelihood"


if (ifvec)
    sumtabf = 'res_sum_table_exp_vector_SF.txt';
    tabf = 'res_table_exp_vector_SF.txt';
    ...
    sumtabf = 'res_sum_table_exp_scalar_SF.txt';
    tabf = 'res_table_exp_scalar_SF.txt';  
    fid_sum_table = fopen(sumtabf,'a');
