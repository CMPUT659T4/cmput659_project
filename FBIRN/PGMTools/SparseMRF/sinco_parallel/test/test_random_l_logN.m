...
usediag=0; % 0 - regularize diagonal, 1 - "regularized likelihood"
    ...
    sumtabf = 'res_sum_table_l=logN_rand_p100sp1_SINCO_20_tol-6.txt';
    tabf = 'res_table_l=logN_rand_p100sp1_SINCO_20_tol-6.txt';  
...
%Nvec = [50 100 200 500 1000 5000 10000 100000];
