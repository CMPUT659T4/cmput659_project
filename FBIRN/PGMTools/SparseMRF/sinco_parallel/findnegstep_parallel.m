...
function alpha=findnegstep_parallel(K, Ws, i, j, As, Ss, Cps, Cpps, update) 

% Modified this function to be more efficient when used with parfor. We avoid sending the whole
% matrices for A,S,W,Cp,Cpp. Instead we replace each with a struct that has params ij,ji,ii,jj. 
% E.g. Ws.ii
